...
# Se no seu computador estiver em outro lugar, ajuste o caminho acima.
...
def ocr_tiff_to_text(tiff_path: str) -> str:
    ...
    # Sem parâmetro de idioma: usa o padrão instalado (geralmente eng)
...
class ImoveisApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        # Campo "Desde" para últimas alterações
    ...
    def importar_tiff(self):
        ...
        try:
            ...
            new_id = save_dict_to_db(data, db_path=self.db_path)
            messagebox.showinfo("Sucesso", f"Registro salvo com ID {new_id}")
            self.load_registros()
        except Exception as e:
            messagebox.showerror("Erro ao importar TIFF", str(e))
